...
static M5DisplayTask internalDisplayTask;
...
void M5DisplayTask::Initialize(Configuration *configuration,
...
void M5DisplayTask::ProcessBuffer(DisplayBuffer *displayBuffer) {
...
void M5DisplayTask::SendMessage(uint8_t *transmissionBuffer) {
	esp_err_t ret;
